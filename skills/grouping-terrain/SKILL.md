...
```bash
python skills/grouping-terrain/scripts/grouping_map.py game/randmaps/groupings/EU_Island_Bastille.xml <scratchpad>/bastille.png
...
```bash
S=skills/grouping-terrain/scripts; U="C:/Users/TIGO/Games/Age of Empires 3 DE/76561198347905238/RandMaps/groupings"
