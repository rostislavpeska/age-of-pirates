...
nothing.
    ...
    python skills/mod-deploy-check/scripts/prezip_check.py            # audit the folders
    python skills/mod-deploy-check/scripts/prezip_check.py --zip age-of-pirates.zip
    python skills/mod-deploy-check/scripts/prezip_check.py --root <mod folder>
...
def _load_bartool():
    ...
    cand = os.path.normpath(os.path.join(here, "..", "..", "aoe3de-bar-archives", "scripts"))
