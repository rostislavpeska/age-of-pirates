...
6. Run `scripts/audit_mesh.py` after meaningful geometry changes. Read its report; count/UV/degenerate checks do not prove clean intersections, plausible profiles or runtime compatibility.
