...
void main(void)
{
	...
	int hinterNbox = rmCreateBoxConstraint("north hinterland box",
		nx1 - margin - hinterSide, nz6,
		nx5 + flankProm + hinterSide, nz6 + hinterDeep, 0.01);
	int hinterN = rmCreateArea("hinterlandNorth");
	rmSetAreaSize(hinterN, 0.4, 0.4);
	rmSetAreaLocation(hinterN, nx3, nz6 + hinterDeep * 0.5);
	...
	rmAddAreaInfluenceSegment(hinterN, nx1, nz6, nx5, nz6);
	...
	int hinterSbox = rmCreateBoxConstraint("south hinterland box",
		sx1 - flankProm - hinterSide, sz6 - hinterDeep,
		sx5 + margin + hinterSide, sz6, 0.01);
	int hinterS = rmCreateArea("hinterlandSouth");
	rmSetAreaSize(hinterS, 0.4, 0.4);
	rmSetAreaLocation(hinterS, sx3, sz6 - hinterDeep * 0.5);
	...
	rmAddAreaInfluenceSegment(hinterS, sx1, sz6, sx5, sz6);
