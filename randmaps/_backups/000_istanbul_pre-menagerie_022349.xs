...
void main(void)
{
	...
	// natives and fort on z1, the factory on z4, and the two construction
	// blocks that own the z5 corners.
	...
	// south centre
	xsArraySetVector(gCityLocs, 15, xsVectorSet(sx1, 0.0, sz2));
	xsArraySetVector(gCityLocs, 16, xsVectorSet(sx2, 0.0, sz2));
