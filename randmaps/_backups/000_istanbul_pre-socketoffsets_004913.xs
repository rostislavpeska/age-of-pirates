...
void main(void)
{
	...
	float decoZ = nz1 - promenade + rmZTilesToFraction(decoShoreIn);
	float decoWestX = (nx1 + tradeNX) * 0.5 + rmXTilesToFraction(decoWestNudge);
	float decoEastX = (nx5 + tradeNX) * 0.5 + rmXTilesToFraction(decoEastNudge);
