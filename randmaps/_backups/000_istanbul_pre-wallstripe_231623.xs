...
// --- the cliffs: coherent blobs shaped ONLY by the constraints ---------
	...
	int wallPlacementSW = rmPlaceGroupingInstanceAtLoc(wallSW,
		nx1 - margin - rmXTilesToFraction(wallOutTilesN),
		(nz3 + nz4) * 0.5 + rmZTilesToFraction(wallOffTilesN), 0);
	...
	int wallPlacementNE = rmPlaceGroupingInstanceAtLoc(wallNE,
		sx5 + margin + rmXTilesToFraction(wallOutTilesS),
		(sz3 + sz4) * 0.5 - rmZTilesToFraction(wallOffTilesS), 0);
