...
void main(void)
{
	...
	int avoidGuardW_far2 = rmCreateAreaDistanceConstraint("off west guard far 2", guardW, 20.0);
	int avoidGuardE_far2 = rmCreateAreaDistanceConstraint("off east guard far 2", guardE, 20.0);
...
// --- the cliffs: coherent blobs shaped ONLY by the constraints ---------
	...
	rmSetAreaElevationVariation(fillW, 2.0);
	...
	rmSetAreaElevationVariation(fillE, 2.0);
