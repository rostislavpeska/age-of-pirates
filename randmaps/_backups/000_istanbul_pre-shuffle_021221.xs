...
void main(void)
{
	...
	rmPlaceGroupingAtLoc(bankN, 0, nx2, nz2);
	...
	rmPlaceGroupingAtLoc(bankS, 0, sx2, sz2);
	...
	rmPlaceGroupingAtLoc(embassyN, 0, nx4, nz2);
	...
	rmPlaceGroupingAtLoc(embassyS, 0, sx4, sz2);
	...
	rmPlaceGroupingAtLoc(menagerieN, 0, nx2, nz3);
	...
	rmPlaceGroupingAtLoc(menagerieS, 0, sx2, sz3);
