...
void main(void)
{
	...
	// Florence's back-forest pattern (zp_z_zflorence.xs 1359-1372), verbatim.
	int forestTest = rmCreateArea("back forest test");
	rmSetAreaSize(forestTest, 0.052, 0.052);
	rmSetAreaForestType(forestTest, "Italian Forest");
	rmSetAreaForestDensity(forestTest, 0.7);
	rmSetAreaForestClumpiness(forestTest, 0.4);
	rmSetAreaForestUnderbrush(forestTest, 0.0);
	rmSetAreaCoherence(forestTest, 1.0);
	rmSetAreaMix(forestTest, "italy_grass_lush");
	...
	// --- the two woods: Florence's back-forest block (zp_z_zflorence.xs
	// 1359-1372) copied as-is. Same forest type, density, clumpiness, mix and
	// coherence; only the location differs, and that is hardcoded up top.
	int forestN = rmCreateArea("back forest north");
	rmSetAreaSize(forestN, 0.052, 0.052);
	rmSetAreaForestType(forestN, "Italian Forest");
	rmSetAreaForestDensity(forestN, 0.7);
	rmSetAreaForestClumpiness(forestN, 0.4);
	rmSetAreaForestUnderbrush(forestN, 0.0);
	rmSetAreaCoherence(forestN, 1.0);
	rmSetAreaMix(forestN, "italy_grass_lush");
	...
	int forestS = rmCreateArea("back forest south");
	rmSetAreaSize(forestS, 0.052, 0.052);
	rmSetAreaForestType(forestS, "Italian Forest");
	rmSetAreaForestDensity(forestS, 0.7);
	rmSetAreaForestClumpiness(forestS, 0.4);
	rmSetAreaForestUnderbrush(forestS, 0.0);
	rmSetAreaCoherence(forestS, 1.0);
	rmSetAreaMix(forestS, "italy_grass_lush");
