...
void main(void)
{
	...
	// ========================================================================
	// Guardian nuggets on the trade sockets use this difficulty.
	...
	// guardian nugget for the north flank harbour 5 - lands 4..6 m off the socket
	int nugH5 = rmCreateObjectDef("nugget north flank harbour 5");
	rmAddObjectDefItem(nugH5, "Nugget", 1, 0.0);
	rmSetObjectDefMinDistance(nugH5, 4.0);
	rmSetObjectDefMaxDistance(nugH5, 6.0);
	rmSetObjectDefTradeRouteID(nugH5, tradeRouteN);
	rmPlaceObjectDefAtLoc(nugH5, 0,
		nFlankX  + rmXMetersToFraction(h5SocketOffX),
		nFlank2Z + rmZMetersToFraction(h5SocketOffZ));
	...
	// guardian nugget for the south flank harbour 6 - lands 4..6 m off the socket
	int nugH6 = rmCreateObjectDef("nugget south flank harbour 6");
	rmAddObjectDefItem(nugH6, "Nugget", 1, 0.0);
	rmSetObjectDefMinDistance(nugH6, 4.0);
	rmSetObjectDefMaxDistance(nugH6, 6.0);
	rmSetObjectDefTradeRouteID(nugH6, tradeRouteS);
	rmPlaceObjectDefAtLoc(nugH6, 0,
		sFlankX  + rmXMetersToFraction(h6SocketOffX),
		sFlank2Z + rmZMetersToFraction(h6SocketOffZ));
	...
	// guardian nugget for the north flank harbour 3 - lands 4..6 m off the socket
	int nugH3 = rmCreateObjectDef("nugget north flank harbour 3");
	rmAddObjectDefItem(nugH3, "Nugget", 1, 0.0);
	rmSetObjectDefMinDistance(nugH3, 4.0);
	rmSetObjectDefMaxDistance(nugH3, 6.0);
	rmSetObjectDefTradeRouteID(nugH3, tradeRouteN);
	rmPlaceObjectDefAtLoc(nugH3, 0,
		nFlankX + rmXMetersToFraction(h3SocketOffX),
		nFlankZ + rmZMetersToFraction(h3SocketOffZ));
	...
	// guardian nugget for the south flank harbour 4 - lands 4..6 m off the socket
	int nugH4 = rmCreateObjectDef("nugget south flank harbour 4");
	rmAddObjectDefItem(nugH4, "Nugget", 1, 0.0);
	rmSetObjectDefMinDistance(nugH4, 4.0);
	rmSetObjectDefMaxDistance(nugH4, 6.0);
	rmSetObjectDefTradeRouteID(nugH4, tradeRouteS);
	rmPlaceObjectDefAtLoc(nugH4, 0,
		sFlankX + rmXMetersToFraction(h4SocketOffX),
		sFlankZ + rmZMetersToFraction(h4SocketOffZ));
	...
	// guardian nugget for the north lane harbour - lands 4..6 m off the socket
	int nugHN = rmCreateObjectDef("nugget north lane harbour");
	rmAddObjectDefItem(nugHN, "Nugget", 1, 0.0);
	rmSetObjectDefMinDistance(nugHN, 4.0);
	rmSetObjectDefMaxDistance(nugHN, 6.0);
	rmSetObjectDefTradeRouteID(nugHN, tradeRouteN);
	rmPlaceObjectDefAtLoc(nugHN, 0,
		nx3     + rmXMetersToFraction(hNSocketOffX),
		nTradeZ + rmZMetersToFraction(hNSocketOffZ));
	...
	// guardian nugget for the south lane harbour - lands 4..6 m off the socket
	int nugHS = rmCreateObjectDef("nugget south lane harbour");
	rmAddObjectDefItem(nugHS, "Nugget", 1, 0.0);
	rmSetObjectDefMinDistance(nugHS, 4.0);
	rmSetObjectDefMaxDistance(nugHS, 6.0);
	rmSetObjectDefTradeRouteID(nugHS, tradeRouteS);
	rmPlaceObjectDefAtLoc(nugHS, 0,
		sx3     + rmXMetersToFraction(hSSocketOffX),
		sTradeZ + rmZMetersToFraction(hSSocketOffZ));
