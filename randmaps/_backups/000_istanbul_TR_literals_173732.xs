...
void main(void)
{
	...
	rmAddTradeRouteWaypoint(tradeRouteN, 0.9000, 0.9000);   // enters at the NE corner
	rmAddTradeRouteWaypoint(tradeRouteN, 0.7040, 0.7600);   // out past the north flank harbour
	rmAddTradeRouteWaypoint(tradeRouteN, 0.7040, 0.5400);   // turns down into the channel
	rmAddTradeRouteWaypoint(tradeRouteN, 0.5000, 0.5400);   // mid-channel
	rmAddTradeRouteWaypoint(tradeRouteN, 0.3027, 0.5400);   // start of the 135 corner
	rmAddTradeRouteWaypoint(tradeRouteN, 0.2560, 0.4933);   // end of the 135 corner
	rmAddTradeRouteWaypoint(tradeRouteN, 0.2560, 0.0000);   // pure south to the map edge
	...
	rmAddTradeRouteWaypoint(tradeRouteS, 0.1000, 0.1000);   // enters at the SW corner
	rmAddTradeRouteWaypoint(tradeRouteS, 0.2560, 0.2467);   // out past the south flank harbour
	rmAddTradeRouteWaypoint(tradeRouteS, 0.2560, 0.4600);   // turns up into the channel
	rmAddTradeRouteWaypoint(tradeRouteS, 0.5000, 0.4600);   // mid-channel
	rmAddTradeRouteWaypoint(tradeRouteS, 0.6573, 0.4600);   // start of the 135 corner
	rmAddTradeRouteWaypoint(tradeRouteS, 0.7040, 0.5067);   // end of the 135 corner
	rmAddTradeRouteWaypoint(tradeRouteS, 0.7040, 1.0000);   // pure north to the map edge
