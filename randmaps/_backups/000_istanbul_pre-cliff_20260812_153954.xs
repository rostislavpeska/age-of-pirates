...
void main(void)
{
	...
	rmSetAreaSize(forestN, 0.4, 0.4);
	rmSetAreaLocation(forestN, nx3, hinterEdgeN + hinterDeep * 0.5);
	...
	rmSetAreaSize(forestS, 0.4, 0.4);
	rmSetAreaLocation(forestS, sx3, hinterEdgeS - hinterDeep * 0.5);
