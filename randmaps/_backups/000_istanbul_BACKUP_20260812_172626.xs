...
void main(void)
{
	...
	// ---- LANE SHAPE ------------------------------------------------------
	// The lanes sweep in from the map corners and curve around each island
	// end into the channel. Both in TILES.
	int   laneCurve       = 20;   // radius of the turn into the channel
	int   laneBow         = 16;   // how far the entry run bulges outward
	...
	// LANE WAYPOINTS - PLAIN NUMBERS ON PURPOSE.
	// Worked out offline from the knobs (nBendX 0.7040, nBendZ 0.7600,
	// sBendX 0.2560, sBendZ 0.2467, turn radius 20 tiles, entry bow 16
	// tiles) and written here as literals. No expressions in the script.
	// If the islands or the lane asks move, these must be recomputed.
	// north lane: in from the NE, around the island, west up the channel
	rmAddTradeRouteWaypoint(tradeRouteN, 0.9000, 0.9000);
	rmAddTradeRouteWaypoint(tradeRouteN, 0.8553, 0.8833);
	rmAddTradeRouteWaypoint(tradeRouteN, 0.7040, 0.7600);
	rmAddTradeRouteWaypoint(tradeRouteN, 0.7040, 0.6067);
	rmAddTradeRouteWaypoint(tradeRouteN, 0.6707, 0.5977);
	rmAddTradeRouteWaypoint(tradeRouteN, 0.6463, 0.5733);
	rmAddTradeRouteWaypoint(tradeRouteN, 0.6373, 0.5400);
	rmAddTradeRouteWaypoint(tradeRouteN, 0.5000, 0.5400);
	rmAddTradeRouteWaypoint(tradeRouteN, 0.0000, 0.5400);
	...
	// south lane: the mirror, in from the SW, east up the channel
	rmAddTradeRouteWaypoint(tradeRouteS, 0.1000, 0.1000);
	rmAddTradeRouteWaypoint(tradeRouteS, 0.1247, 0.1200);
	rmAddTradeRouteWaypoint(tradeRouteS, 0.2560, 0.2467);
	rmAddTradeRouteWaypoint(tradeRouteS, 0.2560, 0.3933);
	rmAddTradeRouteWaypoint(tradeRouteS, 0.2893, 0.4023);
	rmAddTradeRouteWaypoint(tradeRouteS, 0.3137, 0.4267);
	rmAddTradeRouteWaypoint(tradeRouteS, 0.3227, 0.4600);
	rmAddTradeRouteWaypoint(tradeRouteS, 0.5000, 0.4600);
	rmAddTradeRouteWaypoint(tradeRouteS, 1.0000, 0.4600);
