...
rmSetAreaMix(southIsland, "california_snowground5");
	rmAddAreaTerrainLayer(southIsland, "Africa\sand_afr", 0, 3);
	rmAddAreaTerrainLayer(southIsland, "Africa\ground1_afr", 3, 5);
	rmAddAreaTerrainLayer(southIsland, "Africa\ground3_afr", 5, 8);
...
rmSetAreaMix(northIsland, "indochina_grass_a");
	rmAddAreaTerrainLayer(northIsland, "borneo\shoreline1_borneo", 0, 3);
	rmAddAreaTerrainLayer(northIsland, "borneo\ground_sand2_borneo", 3, 5);
...
rmSetAreaMix(bonusIslandID, "indochina_grass_a");
	rmAddAreaTerrainLayer(bonusIslandID, "borneo\shoreline1_borneo", 0, 3);
	rmAddAreaTerrainLayer(bonusIslandID, "borneo\ground_sand2_borneo", 3, 5);
...
rmSetAreaMix(bonusIslandID2, "california_snowground5");
	rmAddAreaTerrainLayer(bonusIslandID2, "Africa\sand_afr", 0, 3);
	rmAddAreaTerrainLayer(bonusIslandID2, "Africa\ground1_afr", 3, 5);
	rmAddAreaTerrainLayer(bonusIslandID2, "Africa\ground3_afr", 5, 8);
...
rmSetAreaCliffType(southIslandCliffs, "ZP Australia Rainforest");
...
caribs3VillageID = rmCreateGrouping("caribs3 city", "Native_Aboriginal_0"+caribs3VillageType);
...
for (i=0; <numTries) {   
    ...
    rmSetAreaForestType(forest2, "z80 New Guinea");
...
rmSetObjectDefMaxDistance(nuggetWater, rmXFractionToMeters(10.45));
...
rmSetObjectDefMinDistance(nugget2b, rmXFractionToMeters(0.0));
