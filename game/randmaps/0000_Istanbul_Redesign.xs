...
void main(void)
{
	...
	// ---------------------------------------------------------------
	// BEACHES OFF - the coasts are being rebuilt by hand for the
	// redesign, so the generated beaches would fight the new terrain.
	// Commented out together, because they are interdependent:
	//   beachEdgeRingN/S      pie constraints used by beachN/S
	//   beachN, beachS        the two big edge beaches
	//   beachStraitN/S        the small channel-facing shelves
	//   avoidBeachStraitN/S   derived from beachStraitN/S ...
	//   ... and their four uses on dock2 / dock3 further down.
	// Leaving any one of those live would be an undefined reference.
	// hinterMix and avoidTraderoute5 stay - they are shared with other
	// areas and are still used elsewhere.
	// ---------------------------------------------------------------
...
// --- the cliffs: coherent blobs shaped ONLY by the constraints ---------
	...
	rmAddAreaConstraint(dock2, dockAvoidPirate);
	...
	rmAddAreaConstraint(dock3, dockAvoidPirate);
