...
rmSetAreaSize(northMountainTerrain, 0.25, 0.25);
...
rmSetAreaSize(northMountainTerrain2, 0.10, 0.10);
...
rmSetAreaSize(northIslandCliffs3, 0.05, 0.05);
...
rmSetAreaSize(northIslandCliffs4, 0.025, 0.025);
...
rmSetAreaSize(northMountainTerrain4, 0.025, 0.025);
...
rmSetAreaSize(northIslandCliffs5, 0.010, 0.010);
...
rmSetAreaSize(southMountainTerrain, 0.25, 0.25);
...
rmSetAreaSize(southMountainTerrain2, 0.10, 0.10);
...
rmSetAreaSize(southIslandCliffs3, 0.05, 0.05);
...
rmSetAreaSize(southIslandCliffs4, 0.025, 0.025);
...
rmSetAreaSize(southMountainTerrain4, 0.025, 0.025);
...
rmSetAreaSize(southIslandCliffs5, 0.012, 0.012);
