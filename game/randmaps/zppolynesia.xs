...
int whaleVsWhaleID=rmCreateTypeDistanceConstraint("whale v whale", whale1, 10.0);	
...
/*int connectionID1 = rmCreateConnection ("connection 1 ");
    ...
    rmAddConnectionArea(connectionID1, bonusIsland1);
    rmAddConnectionArea(connectionID1, bonusIsland3);
    rmSetConnectionBaseHeight(connectionID1, 0.5);
    rmSetConnectionHeightBlend(connectionID1, 20);
    rmAddAreaConstraint(connectionID1, islandConstraintLong);
    rmBuildConnection(connectionID1);

    /*int connectionID2 = rmCreateConnection ("connection 2 ");
    ...
    rmAddConnectionArea(connectionID2, bonusIsland2);
    rmAddConnectionArea(connectionID2, bonusIsland3);
    rmSetConnectionBaseHeight(connectionID2, 0.5);
    rmSetConnectionHeightBlend(connectionID2, 20);
    rmBuildConnection(connectionID2);

    int connectionID3 = rmCreateConnection ("connection 3 ");
    ...
    rmAddConnectionArea(connectionID3, bonusIsland3);
    rmAddConnectionArea(connectionID3, bonusIsland4);
    rmSetConnectionBaseHeight(connectionID3, 0.5);
    rmSetConnectionHeightBlend(connectionID3, 20);
...
rmPlaceObjectDefAtLoc(controllerID3, 0, 0.8, 0.4);
rmPlaceObjectDefAtLoc(controllerID2, 0, 0.4, 0.2);
rmPlaceObjectDefAtLoc(controllerID4, 0, 0.2, 0.6);
...
rmSetAreaCliffType(basecliffID, "ZP Hawaii High 2");
rmSetAreaCliffEdge(basecliffID, 1, 1.00, 0.0, 0.0, 2); 
rmSetAreaCliffPainting(basecliffID, true, true, true, 1.5, true);
rmSetAreaBaseHeight(basecliffID, 7.0);
rmSetAreaCliffHeight(basecliffID, 0, 0.1, 0.5);
rmAddAreaConstraint(basecliffID, avoidKOTHshort);
rmAddAreaConstraint(basecliffID, avoidPlayerCenter);
...
rmSetAreaTerrainType(basecliffID2, "lava\volcano_shore");
...
rmSetAreaBaseHeight(basecliffID2, 7.0);
...
rmSetAreaTerrainType(fujiPeaklvl3, "lava\volcano_shore");
...
rmSetAreaCliffType(basecliffID31, "ZP Hawaii High");
...
rmSetAreaCliffType(basecliffID32, "ZP Hawaii High");
...
rmSetAreaCliffType(basecliffID33, "ZP Hawaii High");
...
rmSetAreaCliffType(basecliffID34, "ZP Hawaii High");
