...
void main(void)
{
  ...
  for (i=0; <10) {
    ...
    rmSetAreaSize(dirtPatch, rmAreaTilesToFraction(50), rmAreaTilesToFraction(150));
    rmSetAreaTerrainType(dirtPatch, patchType2);
  ...
  rmPlaceObjectDefPerPlayer(nugget2, false, 2*nuggetCount);
