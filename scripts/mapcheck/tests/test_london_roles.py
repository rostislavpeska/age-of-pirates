...
class TestBridgeOwnership:
    ...
    def test_venice_tower_family(self, xmb_current):
        ...
        pm = _text(REPO / "data/protomods.xml"); assert "CityTowerFlat" not in pm and '<unit id="21196" name="zpAILondonBridge">' in pm and '<unit id="21197" name="zpAILondonConstrMarker">' in pm   # 21196 = the London AI marker since 2026-09-23, 21197 = the construction marker since 2026-09-24 (no 'is last' pin: 21198+ are later protos, test conventions)
