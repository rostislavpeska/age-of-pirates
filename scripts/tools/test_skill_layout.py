...
class SkillLayoutTests(unittest.TestCase):
    ...
    def test_deployment_and_string_tools_use_the_single_bar_implementation(self):
        deploy = read_module(ROOT / 'skills/mod-deploy-check/scripts/prezip_check.py')
        self.assertIsNotNone(deploy['BARTOOL'])
        expected = ROOT / 'skills/aoe3de-bar-archives/scripts/bartool.py'
    ...
    def test_exporter_reads_universal_source(self):
        ...
        self.assertEqual(module['SOURCE_ROOT'], ROOT / 'skills')
