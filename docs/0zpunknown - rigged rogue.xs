...
//		else
   ...
   // pie constraints
	...
	int avoidCenterFar = rmCreatePieConstraint("avoid center far",0.5,0.5,rmXFractionToMeters(0.38), rmXFractionToMeters(0.45), rmDegreesToRadians(0),rmDegreesToRadians(360));
