...
def inspect(objects):
    ...
    for obj in objects:
        ...
        if any(n not in {'mata', 'matb', 'matc'} for n in mats):
            issues.append('Unexpected/empty material slot; static London profile expects mata/matb/matc')
