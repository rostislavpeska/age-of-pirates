...
Run the bundled checker against the physical `.claude/skills/` directory. It uses Python's
...
python -B .claude/skills/skill-library-audit/scripts/audit_library.py --skills-root .claude/skills --skill aoe3de-building-export
python -B .claude/skills/skill-library-audit/scripts/audit_library.py --skills-root .claude/skills --skill aoe3de-building-export --machine --operation conversion
```
...
```bash
python -B -m unittest discover -s .claude/skills/skill-library-audit/tests -v
```
