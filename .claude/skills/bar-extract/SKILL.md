...
```bash
python .claude/skills/aoe3de-bar-archives/scripts/bartool.py cat data/tactics/dock.tactics
python .claude/skills/aoe3de-bar-archives/scripts/bartool.py extract protoy.xml techtreey.xml civs.xml -o scripts/source --flat --in-repo
python .claude/skills/aoe3de-bar-archives/scripts/xmbc.py check data/protomods.xml
python .claude/skills/aoe3de-bar-archives/scripts/xmbc.py build data/protomods.xml
```
